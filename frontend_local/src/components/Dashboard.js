...
function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 glass-dark border-b border-slate-700/50 p-3 md:p-4 sticky top-0 shadow-premium">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 md:space-x-3">
            <div className="relative w-8 h-8 md:w-10 md:h-10">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl shadow-glow"></div>
              <div className="relative w-full h-full bg-gradient-to-br from-blue-500 to-blue-700 rounded-xl flex items-center justify-center border border-blue-400/30">
            ...
            <div>
              <h1 className="text-lg md:text-xl font-bold gradient-text tracking-wide">INTELLICAM</h1>
              <p className="text-xs md:text-sm text-slate-400 hidden sm:block font-medium">Security Intelligence Platform</p>
            </div>
          </div>
          <div className="flex items-center space-x-2 md:space-x-6">
            <div className="hidden md:flex items-center space-x-4">
              <div className="flex items-center space-x-2 px-3 py-1.5 glass-dark rounded-lg">
                <div className={isMonitoring ? 'status-online' : 'status-offline'}></div>
              ...
              <button
                ...
                className={soundEnabled ? 'btn-secondary' : 'btn-ghost'}
              >
            ...
            <div className="card-hover p-4 group">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-red-400 group-hover:text-red-300 transition-colors">{alerts.length}</p>
                  <p className="text-xs text-slate-500 mt-1 font-medium">All time</p>
                </div>
                <div className="w-12 h-12 bg-gradient-to-br from-red-600/20 to-red-700/20 rounded-xl flex items-center justify-center group-hover:shadow-glow transition-all duration-300">
